...
export default function NewProject({ onAdd, onCancel }) {
    ...
    function handleSave() {
        ...
        if (enteredTitle.trim() === '' || enteredDescription.trim() === '' || enteredDueDate.trim() === '') {
            ...
            modal.current.open();
            return; // we are returning it becaususe now we need not to save the value
        }
        onAdd({
            title: enteredTitle,
    ...
    return (
        <>
            <Modal ref={modal} buttonCaption="Close">
                ...
                <p className="text-stone-600 mb-4">Please make sure you provide a valid value for every entered field.</p>
            </Modal>
